...
residual = zeros(54, 1);
    ...
    residual(33) = (y(60)) - (params(49)*y(16)+x(it_, 1));
    residual(34) = (y(61)) - (params(50)*y(17)+x(it_, 2));
    residual(35) = (y(62)) - (params(51)*y(18)+x(it_, 3)+params(53)*x(it_, 4));
    residual(36) = (y(63)) - (x(it_, 4)+params(52)*y(19));
    residual(37) = (y(64)) - (params(54)*y(20)+x(it_, 5)-params(55)*y(26));
