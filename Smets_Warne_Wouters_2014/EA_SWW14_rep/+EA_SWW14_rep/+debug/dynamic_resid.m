...
rhs(32) = y(61)-y(86);
lhs(33) = y(90);
rhs(33) = params(52)*y(36)+x(4);
lhs(34) = y(87);
rhs(34) = params(49)*y(33)+x(1);
lhs(35) = y(89);
rhs(35) = params(51)*y(35)+x(3)+x(4)*params(53);
lhs(36) = y(91);
rhs(36) = params(54)*y(37)+x(5)-params(55)*y(53);
lhs(37) = y(88);
rhs(37) = params(50)*y(34)+x(2);
lhs(38) = y(94);
